...
const fixtures = [
  ...
  { href: "/fixtures/primitives", step: 3, title: "Surface and the six primitives", line: "Type scale, the three surface levels, Button, Chip, Card, Bubble, Field, Toggle." },
  ...
  { href: "/fixtures/tool", step: "release 5", title: "The Tool and Document templates", line: "The admin’s shell with every region filled — menu, header, main, inspector, bar — and the 68ch reading column with every element markdown produces." },
  { href: "/fixtures/bento", step: 11, title: "Bento widgets", line: "The six section widgets at full size and at the 0.27 overview, each carrying its field illustration." },
  ...
  { href: "/", step: 10, title: "The portfolio", line: "All of it, as pages: the intro and the six section widgets, each one a link to its own page." },
];
