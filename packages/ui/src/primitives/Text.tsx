...
/**
 * Text (§9) — every run of words on the platform, at one of three sizes.
 *
 ...
 * reading matter, `small` 14.5/1.5 is an aside. `tone="muted"` is the only colour it offers, because a run of
 * prose that needs a colour needs a component.
 */
...
const SIZE = { lead: "noo-lead", body: "noo-body", small: "noo-body-sm" } as const;
