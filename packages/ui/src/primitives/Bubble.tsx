...
/**
 * Bubble (§9) — a glass-1 pill of real text, `bubble` type (15/1.40, Hanken 500), padding 10 × 16.
...
export function Bubble({ tint, pop, as, className, ...rest }: BubbleProps) {
  ...
  return <Tag className={cx("glass glass-1 noo-bubble", tint && "noo-bubble--tint", pop && "pop-in", className)} data-hue={tint} {...rest} />;
}
