...
export { Deck } from "./primitives/Deck";
export type { DeckProps } from "./primitives/Deck";
...
export { ProfileCard } from "./blocks/ProfileCard";
export type { ProfileCardProps } from "./blocks/ProfileCard";
